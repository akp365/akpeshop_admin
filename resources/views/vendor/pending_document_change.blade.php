@extends('layout')
@section('page_title', 'Pending Document Change Requests')
@section('content')

<h4 class="page-section-heading">Pending Document Change Requests</h4>
...
<script type="text/javascript">
    ...
    $(function() {
        datasTable = $('.data-table').DataTable({
            ...
            bAutoWidth: false,
            scrollX: true,
            ajax: "{{ route('document-change-request') }}",
            columns: [
                {
                    data: 'formatted_date',
                    name: 'formatted_date',
