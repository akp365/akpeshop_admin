                    ...
                    <div class="split-vertical-body">
                        <div class="split-vertical-cell">
                            <div data-scrollable>
                                ...
                                <!-- DASHBOARD -->
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="{{ Route::currentRouteName() == 'dashboard ' ? 'active' : ''}}"><a href="{{ route('dashboard') }}"><span>Dashboard</span></a></li>
                                </ul>
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                ...
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="{{ Route::currentRouteName() == 'looks' ? 'active' : ''}}"><a href="{{ route('VendorWithdraw') }}"><span>Withdrawal Request</span></a></li>
                                </ul>
                                ...
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="{{ Route::currentRouteName() == 'settings' ? 'active' : ''}}"><a href="{{ route('settings') }}"><i class="fa fa-cog"></i> <span>Others Settings</span></a></li>
                                </ul>
                            </div>
                        </div>
