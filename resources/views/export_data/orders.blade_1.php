...
$('.data-table_details').DataTable({
    ...
    columns: [
        ...
        // order_more_info
        { data: 'invoice_value', name: 'invoice_value', title: 'Invoice Value' },
        ...
        { data: 'discount', name: 'discount', title: 'Coupon Discount' },
        ...
        { data: 'seller_payable', name: 'seller_payable', title: 'Seller/Agent Payable' },
